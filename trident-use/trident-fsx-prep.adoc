...
NOTE: Assurez-vous de suivre les étapes de préparation des nœuds requises pour Amazon Linux et Ubuntu https://["Images de machine Amazon"^] (AMIS) en fonction de votre type ami EKS.
