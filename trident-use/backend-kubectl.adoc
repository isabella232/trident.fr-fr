...
----
Vous pouvez également consulter les exemples de la https://["programme d'installation trident"^] répertoire des exemples de configuration pour la plate-forme/le service de stockage souhaité.
...
. Créer un https://["Le secret de Kubernetes"^]. Le secret est qu'Astra Trident doit communiquer avec le cluster/service de stockage.
