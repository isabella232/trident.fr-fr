...
Utilisation d'Amazon FSX pour NetApp ONTAP https://["FabricPool"^] pour gérer les niveaux de stockage. Elle vous permet de stocker les données au niveau le plus important, selon que celles-ci sont fréquemment utilisées.
...
* https://["Documentation Amazon FSX pour NetApp ONTAP"^]
* https://["Billet de blog sur Amazon FSX pour NetApp ONTAP"^]
