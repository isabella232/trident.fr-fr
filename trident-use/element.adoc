...
== Exemple 1 : configuration back-end pour le pilote solidfire-san avec trois types de volumes
...
== Exemple 2 : configuration back-end et classe de stockage pour le pilote SolidFire-san avec des pools de stockage virtuels
