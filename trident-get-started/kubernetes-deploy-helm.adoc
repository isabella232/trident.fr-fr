...
----
. Utiliser `helm install` et spécifiez un nom pour votre déploiement comme dans l'exemple suivant où `23.01.0` Est la version d'Astra Trident que vous installez.
+
[listing]
----
