...
Vous pouvez ensuite importer les volumes récupérés dans Astra Trident à l'aide de link:trident-use/vol-import.adoc["importation de volume tridentctl"].
...
+
link:trident-use/vol-snapshots.adoc["Snapshots de volume"]
