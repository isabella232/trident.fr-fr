...
* Vérifiez que vous disposez d'une version prise en charge de Docker installée. Si votre version de Docker est obsolète, https://["installez-le ou mettez-le à jour"^].
+
[listing]
----
docker --version
