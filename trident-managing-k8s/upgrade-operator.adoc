...
`bundle_pre_1_25.yaml` ou `bundle_post_1_25.yaml` Basé sur votre version de Kubernetes. Par exemple, si vous installez Astra Trident 23.07, exécutez la commande suivante :
+
[listing]
----
